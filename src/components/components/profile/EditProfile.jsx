        ...
        <div className="div__in__edit">
          <div className="h1__user">
            <div className="heading">
              <h1 className="h1">User Setting</h1>
            </div>
            <div className="list__edit">
              <ul className="ul__edit">
                <li className="li__edit">
                ...
                <li>
                  <img className="icon" src={two} /> EMAIL NOTFICATION
                </li>
                <li>
                  <img className="icon" src={thr} /> MANAGE BLOG
                </li>
                <li>
                  <img className="icon" src={fre} /> DEVELOPER
                </li>
                <li>
                  <img className="icon" src={fou} /> ACCOUNT
                </li>
              </ul>
            </div>
          </div>
