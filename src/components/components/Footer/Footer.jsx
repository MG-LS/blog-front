...
const Footer = () => {
  return (
    <div className="css-ojxokl">
      <div className="css-swaup">
        <div className="css-1jmjd9m">
          <h3 className="css-1xwuxqb">Explore</h3>
          <ul className="css-ul">
            <li className="css-6l27w5">
              <a href="/community?source=hashnode-footer" className="css-16ukx9s">
                Feed
              </a>
            </li>
            <li className="css-6l27w5">
              <a
                href="/explore/blogs?source=hashnode-footer"
                className="css-16ukx9s"
              >
                Trending Blogs
              </a>
            </li>
            <li className="css-6l27w5">
              <a
                href="/explore/tags?source=hashnode-footer"
                className="css-16ukx9s"
              >
                Tags
              </a>
            ...
            <li className="css-6l27w5">
              <a href="/search?source=hashnode-footer" className="css-16ukx9s">
                Search
              </a>
            </li>
            <li className="css-6l27w5">
              <a href="/teams?source=hashnode-footer" className="css-16ukx9s">
                Hashnode for Teams
              </a>
            </li>
            <li className="css-6l27w5">
              <a
                href="https://api.hashnode.com/?source=hashnode-footer"
                target="_blank"
                rel="noreferrer"
                className="css-16ukx9s"
              >
        ...
        <div className="css-1jmjd9m">
          <h3 className="css-1xwuxqb">Company</h3>
          <ul>
            <li className="css-6l27w5">
              <a href="/about?source=hashnode-footer" className="css-16ukx9s">
                About Hashnode
              </a>
            </li>
            <li className="css-6l27w5">
              <a href="/careers?source=hashnode-footer" className="css-16ukx9s">
                Careers
              </a>
            </li>
            <li className="css-6l27w5">
              <a href="/media?source=hashnode-footer" className="css-16ukx9s">
                Logos &amp; Media
              </a>
            </li>
            <li className="css-6l27w5">
              <a
                href="https://feedback.hashnode.com/changelog"
                target="_blank"
                rel="noreferrer"
                className="css-16ukx9s"
              >
        ...
        <div className="css-1jmjd9m">
          <h3 className="css-1xwuxqb">Comparisons</h3>
          <ul>
            <li className="css-6l27w5">
              <a href="/vs/medium?source=hashnode-footer" className="css-16ukx9s">
                Hashnode vs Medium
              </a>
            </li>
            <li className="css-6l27w5">
              <a href="/vs/ghost?source=hashnode-footer" className="css-16ukx9s">
                Hashnode vs Ghost
              </a>
            </li>
            <li className="css-6l27w5">
              <a
                href="/vs/wordpress?source=hashnode-footer"
                className="css-16ukx9s"
              >
            ...
            <li className="css-6l27w5">
              <a href="/vs/devto?source=hashnode-footer" className="css-16ukx9s">
                Hashnode vs Dev.to
              </a>
            </li>
            <li className="css-6l27w5">
              <a href="/vs/substack?source=hashnode-footer" className="css-16ukx9s">
                Hashnode vs Substack
              </a>
            </li>
            <li className="css-6l27w5">
              <a
                href="/vs/wordpress-substack?source=hashnode-footer"
                className="css-16ukx9s"
              >
            ...
            <li className="css-6l27w5">
              <a
                href="/vs/medium-substack?source=hashnode-footer"
                className="css-16ukx9s"
              >
        ...
        <div className="css-1jmjd9m">
          <h3 className="css-1xwuxqb">Support</h3>
          <ul>
            <li className="css-6l27w5">
              <a
                href="https://support.hashnode.com?source=hashnode-footer"
                target="_blank"
                rel="noreferrer"
                className="css-16ukx9s"
              >
            ...
            <li className="css-6l27w5">
              <a href="#support" className="css-16ukx9s">
                Contact
              </a>
            </li>
            <li className="css-6l27w5">
            ...
            <li className="css-6l27w5">
              <a
                href="https://feedback.hashnode.com/"
                target="_blank"
                rel="noreferrer"
                className="css-16ukx9s"
              >
        ...
        <div className="css-1jmjd9m">
          <h3 className="css-1xwuxqb">Official Blogs</h3>
          <ul>
            <li className="css-6l27w5">
              <a
                href="https://townhall.hashnode.com?source=hashnode-footer"
                target="_blank"
                rel="noreferrer"
                className="css-16ukx9s"
              >
            ...
            <li className="css-6l27w5">
              <a
                href="https://web3.hashnode.com/?source=hashnode-footer"
                target="_blank"
                rel="noreferrer"
                className="css-16ukx9s"
              >
            ...
            <li className="css-6l27w5">
              <a
                href="https://web3.hashnode.com/glossary?source=hashnode-footer"
                target="_blank"
                rel="noreferrer"
                className="css-16ukx9s"
              >
            ...
            <li className="css-6l27w5">
              <a
                href="https://aws.hashnode.com/?source=hashnode-footer"
                target="_blank"
                rel="noreferrer"
                className="css-16ukx9s"
              >
            ...
            <li className="css-6l27w5">
              <a
                href="https://toolbox.hashnode.com/?source=hashnode-footer"
                target="_blank"
                rel="noreferrer"
                className="css-16ukx9s"
              >
      ...
      <div className="css-j1vi2j">
        <p className="css-fwylhz">© Hashnode 2022</p>
        <a href="/privacy" className="css-3lg6qr">
          Privacy Policy
        </a>
        <a href="/terms" className="css-3lg6qr">
          Terms
        </a>
        <a href="/code-of-conduct" className="css-3lg6qr">
          Code of Conduct
        </a>
      </div>
      <div className="css-17b2io4">
        <a
          href="/"
          title="Hashnode"
          aria-label="Hashnode logo"
          className="css-6hp4m9"
        >
          <svg className="css-1irbveh" viewBox="0 0 688 118" fill="none">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
